...
# These can be extended with actual model performance data
MODEL_RECOMMENDATIONS = {
    "cost_optimized": "mistral:7b-instruct",  # Lower cost, good performance
    "latency_optimized": "mistral:7b-instruct",  # Fast inference
    "accuracy_optimized": "mistral:7b-instruct",  # Higher accuracy (can be upgraded to larger model)
...
def promote_model(
    ...
    try:
        ...
        if active_model:
            ...
            active_model.last_promoted_at = datetime.utcnow()
        else:
            # Create new
